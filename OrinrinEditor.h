...
#define YY2_CRLF	6	//!<	ＹＹ카키코 게시판 개행 바이트 수
#define STRB_CRLF	4	//!<	시타라바 게시판 개행 바이트 수

#define PAGE_BYTE_MAX	4096	//!<	1레스 최대 바이트 수

#define MODIFY_MSG	TEXT("[수정됨]")
//-------------------------------------------------------------------------------------------------

//	したらば用色指定タグ
#define COLOUR_TAG_WHITE	TEXT("[spo]")	//!<	스포 태그 열기
#define COLOUR_TAG_CLOSPO	TEXT("[/spo]")	//!<	스포 태그 닫기
#define COLOUR_TAG_BLUE		TEXT("[clr blue blue]")	//!<	컬러 태그 파랑
#define COLOUR_TAG_BLACK	TEXT("[clr black black]")	//!<	컬러 태그 검정
#define COLOUR_TAG_RED		TEXT("[clr red red]")	//!<	컬러 태그 빨강
#define COLOUR_TAG_GREEN	TEXT("[clr green green]")	//!<	컬러 태그 초록
#define COLOUR_TAG_CLOCLR	TEXT("[/clr]")	//!<	컬러 태그 닫기
...
typedef struct tagFRAMEINFO
{
	...
	INT		dLeftOffset;	//!<	좌측 문자열 여백・０이 좌상 문자 시작점
	INT		dRightOffset;	//!<	우측 문자열 여백・０은 우상 문자 시작점
