...
CONST ENTITYLIST	gstEttySP[] = {
	{ 0x0022,	("&quot;"),		TEXT("&quot;"),     TEXT("큰따옴표") },	//	34
	{ 0x0026,	("&amp;"),		TEXT("&amp;"),		TEXT("앰퍼샌드") },	//	38
	{ 0x003C,	("&lt;"),		TEXT("&lt;"),		TEXT("작은 부등호") },	//	60
	{ 0x003E,	("&gt;"),		TEXT("&gt;"),		TEXT("큰 부등호") },	//	62
	{ 0x0000,	(" "),			TEXT(" "),			TEXT("더미 문자") }
};

//	SJISじゃ表現出来ないアレ
CONST ENTITYLIST	gstEtyAlpha[] = {
	{ 0x00C1,	("&Aacute;"),	TEXT("&Aacute;"),	TEXT("양음 부호 붙은 대문자 A") },	//	193		
	{ 0x00E1,	("&aacute;"),	TEXT("&aacute;"),	TEXT("양음 부호 붙은 소문자 A") },	//	225		
	{ 0x00C2,	("&Acirc;"),	TEXT("&Acirc;"),	TEXT("곡절 부호 붙은 대문자 A") },	//	194		
	{ 0x00E2,	("&acirc;"),	TEXT("&acirc;"),	TEXT("곡절 부호 붙은 소문자 A") },	//	226		
	{ 0x00B4,	("&acute;"),	TEXT("&acute;"),	TEXT("양음 부호") },	//	180		
	{ 0x00C6,	("&AElig;"),	TEXT("&AElig;"),	TEXT("대문자 AE") },	//	198		
	{ 0x00E6,	("&aelig;"),	TEXT("&aelig;"),	TEXT("소문자 AE") },	//	230		
	{ 0x00C0,	("&Agrave;"),	TEXT("&Agrave;"),	TEXT("억음 부호 붙은 대문자 A") },	//	192		
	{ 0x00E0,	("&agrave;"),	TEXT("&agrave;"),	TEXT("억음 부호 붙은 소문자 A") },	//	224		
	{ 0x2135,	("&alefsym;"),	TEXT("&alefsym;"),	TEXT("알레프") },	//	8501		
	{ 0x0391,	("&Alpha;"),	TEXT("&Alpha;"),	TEXT("대문자 알파") },	//	913		
	{ 0x03B1,	("&alpha;"),	TEXT("&alpha;"),	TEXT("소문자 알파") },	//	945		
	{ 0x2227,	("&and;"),		TEXT("&and;"),		TEXT("논리곱 기호") },	//	8743
	{ 0x2220,	("&ang;"),		TEXT("&ang;"),		TEXT("각도 기호") },	//	8736
	{ 0x00C5,	("&Aring;"),	TEXT("&Aring;"),	TEXT("윗고리 붙은 대문자 A") },	//	197		
	{ 0x00E5,	("&aring;"),	TEXT("&aring;"),	TEXT("윗고리 붙은 소문자 A") },	//	229		
	{ 0x2248,	("&asymp;"),	TEXT("&asymp;"),	TEXT("근사 기호") },	//	8776		
	{ 0x00C3,	("&Atilde;"),	TEXT("&Atilde;"),	TEXT("물결표 붙은 대문자 A") },	//	195		
	{ 0x00E3,	("&atilde;"),	TEXT("&atilde;"),	TEXT("물결표 붙은 소문자 A") },	//	227		
	{ 0x00C4,	("&Auml;"),		TEXT("&Auml;"),		TEXT("트레마 붙은 대문자 A") },	//	196
	{ 0x00E4,	("&auml;"),		TEXT("&auml;"),		TEXT("트레마 붙은 소문자 A") },	//	228
	{ 0x0000,	(" "),			TEXT(" "),			TEXT("더미 문자") }
};
...
/*
	...
	{ 0x00BE,	("&frac34;"),	TEXT("&frac34;"),	TEXT("4分の3") },	//	190
	{ 0x00BF,	("&iquest;"),	TEXT("&iquest;"),	TEXT("逆疑問符") },	//	191
	{ 0x00C0,	("&Agrave;"),	TEXT("&Agrave;"),	TEXT("グレーブアクセント대문자 A") },	//	192
	{ 0x00C1,	("&Aacute;"),	TEXT("&Aacute;"),	TEXT("アキュートアクセント대문자 A") },	//	193
	{ 0x00C2,	("&Acirc;"),	TEXT("&Acirc;"),	TEXT("サーカムフレックスアクセント대문자 A") },	//	194
	{ 0x00C3,	("&Atilde;"),	TEXT("&Atilde;"),	TEXT("チルド대문자 A") },	//	195
	{ 0x00C4,	("&Auml;"),		TEXT("&Auml;"),		TEXT("ダイエレシス대문자 A") },	//	196
	{ 0x00C5,	("&Aring;"),	TEXT("&Aring;"),	TEXT("上リング대문자 A") },	//	197
	...
	{ 0x00DE,	("&THORN;"),	TEXT("&THORN;"),	TEXT("アイスランド語THORN") },	//	222
	{ 0x00DF,	("&szlig;"),	TEXT("&szlig;"),	TEXT("ドイツ語エスツェット") },	//	223
	{ 0x00E0,	("&agrave;"),	TEXT("&agrave;"),	TEXT("グレーブアクセント대문자 A小文字") },	//	224
	{ 0x00E1,	("&aacute;"),	TEXT("&aacute;"),	TEXT("アキュートアクセント대문자 A小文字") },	//	225
	{ 0x00E2,	("&acirc;"),	TEXT("&acirc;"),	TEXT("サーカムフレックスアクセント대문자 A小文字") },	//	226
	{ 0x00E3,	("&atilde;"),	TEXT("&atilde;"),	TEXT("チルド대문자 A小文字") },	//	227
	{ 0x00E4,	("&auml;"),		TEXT("&auml;"),		TEXT("ダイエレシス대문자 A小文字") },	//	228
	{ 0x00E5,	("&aring;"),	TEXT("&aring;"),	TEXT("上リング대문자 A小文字") },	//	229
