...
INT ViewInsertColourTag( UINT dCommando )
{
	...
	switch( dCommando )
	{
        ...
        case IDM_INSTAG_CLOSPO:	StringCchCopy(atString, MAX_STRING, COLOUR_TAG_CLOSPO );	break;
        ...
        case IDM_INSTAG_CLOCLR:	StringCchCopy(atString, MAX_STRING, COLOUR_TAG_CLOCLR );	break;
		default:	return 0;
	}
