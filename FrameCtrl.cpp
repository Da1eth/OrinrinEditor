...
CONST  TCHAR	*gatDefaultName[20] = {
	{ TEXT("ALPHA") },	    	{ TEXT("BRAVO") },	    { TEXT("CHARLIE") },	    { TEXT("DALETH") },	    	{ TEXT("ECHO") },
	{ TEXT("FOXTROT") },    	{ TEXT("GOLF") },	    { TEXT("HOTEL") },		    { TEXT("INDIA") },		    { TEXT("JULIETTE") },
	{ TEXT("KOZIRO") },		    { TEXT("LIMA") },		{ TEXT("MIKE") },		    { TEXT("NINGGEN") },    	{ TEXT("OSCAR") },
	{ TEXT("POPPA") },		    { TEXT("QUEBEC") },    	{ TEXT("REISSUECAT") },	    { TEXT("SIERRA") },	    	{ TEXT("TANGO") }
};
...
//	TBADDBITMAP	stToolBmp;
	...
	StringCchCopy( atBuffer, MAX_STRING, TEXT("삽입하고 창 닫기") );
	gstFIBTBInfo[23].iString = SendMessage( ghFIBtlbrWnd, TB_ADDSTRING, 0, (LPARAM)atBuffer );
	StringCchCopy( atBuffer, MAX_STRING, TEXT("박스 크기에 말풍선 맞추기\r\n(빈 공간이 생길 수 있습니다.)") );
...
VOID Fib_OnKey( HWND hWnd, UINT vk, BOOL fDown, int cRepeat, UINT flags )
{
	...
	if( fDown )
	{
		switch( vk )
		{
			case VK_RIGHT:	TRACE( TEXT("→") );	rect.left++;	break;
...
//	TRACE( TEXT("%d x %d"), xEt, yEt );
	...
	StringCchPrintf( atBuffer, SUB_STRING, TEXT("말풍선 %d번째 줄 %d도트"), dLine, xSb );
