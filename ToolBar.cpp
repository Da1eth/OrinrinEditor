...
static CONST TCHAR	gatMainTBtext[TB_MAIN_ITEMS][TBT_STRING] = { 
	{ TEXT("새 파일") },	{ TEXT("불러오기") },	{ TEXT("저장하기") },	{ TEXT("") },
	{ TEXT("환경설정") }
};
...
static CONST TCHAR	gatEditTBtext[TB_EDIT_ITEMS][TBT_STRING] = { 
	{ TEXT("실행 취소") },	{ TEXT("다시 실행") },	{ TEXT("") },
	{ TEXT("잘라내기") },	{ TEXT("복사하기") },	{ TEXT("붙여넣기") },	{ TEXT("지우기") },	{ TEXT("") },
	{ TEXT("유니코드를 코드 모양으로 복사") },	{ TEXT("전체를 SJIS 복사") },	{ TEXT("") },
	{ TEXT("전체 선택") },	{ TEXT("직사각형 선택 모드") },	{ TEXT("") },
	{ TEXT("레이어 박스") },	{ TEXT("") },
	{ TEXT("커서를 기준으로 새 페이지 분할") },	{ TEXT("") },
	{ TEXT("분할 선택 모드") },	{ TEXT("") },
	{ TEXT("유니코드 공백 사용") }
};
...
static  TBBUTTON	gstInsertTBInfo[] = {
	...
	{  3, IDM_USERINS_NA,		TBSTATE_ENABLED,	TBSTYLE_DROPDOWN | TBSTYLE_AUTOSIZE,	{0, 0}, 0, 0  }/*미사용 기능 삭제,	//	
	{  0, 0,					TBSTATE_ENABLED,	TBSTYLE_SEP,							{0, 0}, 0, 0  },
...
static CONST TCHAR	gatInsertTBtext[TB_INSERT_ITEMS][TBT_STRING] = { 
	{ TEXT("유니코드 공백") },	{ TEXT("색상 태그") },	{ TEXT("말풍선") },	{ TEXT("유저 제작 템플릿") },/*미사용 기능 삭제	{TEXT("")},
	{ TEXT("문자 변환 박스") }*/
};
...
static CONST TCHAR	gatLayoutTBtext[TB_LAYOUT_ITEMS][TBT_STRING] = { 
	{ TEXT("우측에 직선 추가") },	{ TEXT("좌측 공백을 오른쪽으로 밀기") },	{ TEXT("") },
	{ TEXT("좌측 공백을 왼쪽으로 당기기") },	{ TEXT("줄 끝에 남는 공백 제거") },	{ TEXT("줄 끝 마지막 문자 제거") },	{ TEXT("") },
	{ TEXT("좌우 반전") },	{ TEXT("상하 반전") },	{ TEXT("") },
	{ TEXT("전체를 오른쪽으로 많이 밀기") },	{ TEXT("공백을 1도트 늘리기") },	{ TEXT("공백을 1도트 줄이기") },	{ TEXT("") },
	{ TEXT("AA 전체를 오른쪽으로 1도트 밀기") },	{ TEXT("AA 전체를 왼쪽으로 1도트 당기기") },	{ TEXT("") },
	{ TEXT("커서를 기준으로 왼쪽으로 당기기") },	{ TEXT("커서를 기준으로 오른쪽으로 밀기") }
};
...
LRESULT ToolBarOnContextMenu( HWND hWnd, HWND hWndContext, LONG xPos, LONG yPos )
{
	...
	AppendMenu( hPopupMenu, MF_STRING, IDM_REBER_DORESET, TEXT("툴바를 초기 상태로 되돌리기") );
	...
	if( TBN_DROPDOWN == pstNmhdr->code )
	{
		...
		switch( iItem )
		{
			...
			case IDM_FRMINSBOX_OPEN:
				hPopupMenu = CreatePopupMenu(  );
				for( i = 0; FRAME_MAX > i; i++ ){	AppendMenu( hPopupMenu, MF_STRING, (IDM_INSFRAME_ALPHA + i), TEXT("말풍선") );	}
